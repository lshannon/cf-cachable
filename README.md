...
When we first hit an endpoint and pass an arguement we get all the logic that runs in the method, this is because there is no key in the cache for this value.
